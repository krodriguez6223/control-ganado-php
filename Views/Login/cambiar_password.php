      ...
      <div class="login-box flipped">
        <div id="divLoading">
         ...
         <form id="formCambiarPass" name="formCambiarPass" class="forget-form" action="">
          <input type="hidden" id="idUsuario" name="idUsuario" value="<?= $data['idpersona']; ?>" requerid>
          <input type="hidden" id="txtEmail" name="txtEmail" value="<?= $data['email']; ?>" requerid>
          <input type="hidden" id="txtToken" name="txtToken" value="<?= $data['token']; ?>" requerid>
